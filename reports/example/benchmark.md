...
`pcopt benchmark --manifest examples/demo/manifest.json --weights examples/demo/portfolio.json --base-currency both --output-dir reports/example --as-of 2026-01-01 --allow-synthetic-demo`
